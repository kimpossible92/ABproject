        ...
        if (timer>=0.5f) {
            if (!iswin)
            {
                ...
                if (mblockposition != null&& levelsApps.ABPoints2[1]!=null)
                {
                    ...
                    print(mblockposition.row + ":" + levelsApps.ABPoints2[1].row);
                    print(mblockposition.col + ":" + levelsApps.ABPoints2[1].col);
                    if (row1 == levelsApps.ABPoints2[1].row &&
                    col1 == levelsApps.ABPoints2[1].col
                //levelsApps.blocksp[levelsApps.sPointBlockB().row * levelsApps.MaxX + levelsApps.sPointBlockB().col]
                ) { iswin = true; }
                }
            }
            timer = 0; }
